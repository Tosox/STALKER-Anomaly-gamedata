...
> [!TIP]  
> This repository exists primarily as a quick reference for browsing the game's files on GitHub.  
> To obtain the unpacked files yourself, you can extract them directly from your local game installation by running `db_unpacker_all.bat`, located in the `tools` folder inside the Anomaly game directory.
